...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { advice: @coach.advice, experience: @coach.experience, fav_event: @coach.fav_event, level_id: @coach.level_id, location: @coach.location, name: @coach.name }
    end
  ...
  test "should update coach" do
    put :update, id: @coach, coach: { advice: @coach.advice, experience: @coach.experience, fav_event: @coach.fav_event, level_id: @coach.level_id, location: @coach.location, name: @coach.name }
    assert_redirected_to coach_path(assigns(:coach))
  end
