class DiscontinueMailer < ActionMailer::Base
  ...
  def gym_notification(notification)
    ...
    if (DiscontinueNotice::LOCATIONS[@discontinue_notice.location][0] == "Granite Bay")
    ...
    elsif (DiscontinueNotice::LOCATIONS[@discontinue_notice.location][0] == "Folsom")
    ...
    elsif (DiscontinueNotice::LOCATIONS[@discontinue_notice.location][0] == "Sacramento")
